...
public class WmMaterialServiceImpl extends ServiceImpl<WmMaterialMapper, WmMaterial> implements WmMaterialService {
    ...
    public ResponseResult cancelCollect(Integer id) {
        ...
        update(Wrappers.<WmMaterial>lambdaUpdate().eq(WmMaterial::getId, id).set(WmMaterial::getType, WemediaConstants.CANCEL_COLLECT_MATERIAL));
        return ResponseResult.okResult(AppHttpCodeEnum.SUCCESS);
    }
    ...
    public ResponseResult collect(Integer id) {
        ...
        update(Wrappers.<WmMaterial>lambdaUpdate().eq(WmMaterial::getId, id).set(WmMaterial::getType, WemediaConstants.COLLECT_MATERIAL));
        return ResponseResult.okResult(AppHttpCodeEnum.SUCCESS);
    }
}
